		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.bluechip_namespaces.current", "id", "pubg"),
					resource.TestCheckResourceAttrWith("data.bluechip_namespaces.current", "items.#", func(value string) error {
						return nil
					}),
				),
			},
