		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.bluechip_oidcauths.current", "id", "pubg"),
					resource.TestCheckResourceAttrWith("data.bluechip_oidcauths.current", "items.#", func(value string) error {
						return nil
					}),
				),
			},
