...
var _ fwbuilder.ResourceBuilderFactory[bluechip.Image] = &BuilderFactory{}

type BuilderFactory struct {
}

func (f *BuilderFactory) New() fwbuilder.ResourceBuilder[bluechip.Image] {
	return &Builder{obj: bluechip.Image{
...
func (b *Builder) Set(field string, value any) error {
	...
	case fwbuilder.FieldSpec:
		b.obj.Spec = value.(bluechip.ImageSpec)
	default:
...
func (b *Builder) Build() bluechip.Image {
	return b.obj
}

var _ fwbuilder.ResourceDebuilderFactory[bluechip.Image] = &DebuilderFactory{}

type DebuilderFactory struct {
}

func (f *DebuilderFactory) New(obj bluechip.Image) fwbuilder.ResourceDebuilder {
