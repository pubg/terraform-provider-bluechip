...
var _ fwbuilder.ResourceBuilderFactory[bluechip.Cidr] = &BuilderFactory{}

type BuilderFactory struct {
}

func (f *BuilderFactory) New() fwbuilder.ResourceBuilder[bluechip.Cidr] {
	return &Builder{obj: bluechip.Cidr{
...
func (b *Builder) Set(field string, value any) error {
	...
	case fwbuilder.FieldSpec:
		b.obj.Spec = value.(bluechip.CidrSpec)
	default:
...
func (b *Builder) Build() bluechip.Cidr {
	return b.obj
}

var _ fwbuilder.ResourceDebuilderFactory[bluechip.Cidr] = &DebuilderFactory{}

type DebuilderFactory struct {
}

func (f *DebuilderFactory) New(obj bluechip.Cidr) fwbuilder.ResourceDebuilder {
