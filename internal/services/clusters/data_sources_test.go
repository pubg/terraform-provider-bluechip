		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.bluechip_clusters.current", "id", "pubg"),
					resource.TestCheckResourceAttrWith("data.bluechip_clusters.current", "items.#", func(value string) error {
						return nil
					}),
				),
			},
