...
var _ fwbuilder.ResourceBuilderFactory[bluechip.ClusterRoleBinding] = &BuilderFactory{}

type BuilderFactory struct {
}

func (f *BuilderFactory) New() fwbuilder.ResourceBuilder[bluechip.ClusterRoleBinding] {
	return &Builder{obj: bluechip.ClusterRoleBinding{
...
type Builder struct {
	obj bluechip.ClusterRoleBinding
}
...
func (b *Builder) Build() bluechip.ClusterRoleBinding {
	return b.obj
}

var _ fwbuilder.ResourceDebuilderFactory[bluechip.ClusterRoleBinding] = &DebuilderFactory{}

type DebuilderFactory struct {
}

func (f *DebuilderFactory) New(obj bluechip.ClusterRoleBinding) fwbuilder.ResourceDebuilder {
