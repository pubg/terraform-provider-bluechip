		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.bluechip_clusterrolebindings.current", "id", "pubg"),
					resource.TestCheckResourceAttrWith("data.bluechip_clusterrolebindings.current", "items.#", func(value string) error {
						return nil
					}),
				),
			},
