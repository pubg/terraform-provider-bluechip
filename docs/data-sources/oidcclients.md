...
page_title: "bluechip_oidcclients Data Source - terraform-provider-bluechip"
subcategory: ""
description: |-
  
---

# bluechip_oidcclients (Data Source)


```terraform
data "bluechip_oidcclients" "current" {
}
```
...
- `assignments` (List of Object) (see [below for nested schema](#nestedobjatt--items--spec--assignments))

<a id="nestedobjatt--items--spec--assignments"></a>
### Nested Schema for `items.spec.assignments`
